...
export async function generateMetadata({
  ...
  try {
    ...
    const canonical = `${process.env.NEXT_PUBLIC_BASE_URL || ''}/catalog/${slug}`
    ...
    return {
      ...
      // Viewport com safe-area para notch/home indicator
      // (Next 14 trata viewport separado do metadata, mas inclui o básico)
      ...
      twitter: {
        ...
        title,
        description,
        images: company.logo_url ? [company.logo_url] : [`/api/pwa-icon/${slug}?size=512`],
      },

      // Meta tags adicionais via other
      other: {
        // PWA / Mobile
